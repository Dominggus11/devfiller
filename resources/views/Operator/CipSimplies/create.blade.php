    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="col-md-12">
                ...
                @endif
                <h3 class="text-center mb-4 text-white">Tambah Cheklist Cip Simply</h3>
                <div>
                    <form action="{{ route('Operator.CipSimplies.store') }}" method="POST">
                        @csrf
                    {{-- card section 1 --}}
                        ...
                        <div class="card-body">
                            @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-1 text-center">
                                        <input type="text" class="form-control" name="status_mesin2{{ $section->id }}" value="{{ $section->status_mesin }}" readonly>
                                    </div>
                                    <div class="col-1 text-center">
                                        <input type="num    ber" class="form-control standar-waktu" name="standar_waktu2{{ $section->id }}" value="{{ $section->standar_waktu }}" readonly>
                                    </div>
                                    <div class="col-1 text-center">
