    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="col-md-12">
                ...
                <div>
                    <form action="{{ route('Operator.CiwSimplies.update', $ciwSimply->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                    {{-- Alat --}}
                    <div>
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <div class="col-sm text-center">
                                        <label for="area" class="font-weight-bold">Shift</label>
                                    </div>
                                    <div class="col-sm text-center">
                                        <label for="area" class="font-weight-bold">line</label>
                                    </div>
                                    <div class="col-sm text-center">
                                        <label for="area" class="font-weight-bold">Nama Operator</label>
                                    </div>
                                    <div class="col-sm text-center">
                                        <label for="area" class="font-weight-bold">Tanggal</label>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm">
                                        <input type="number" max="3" min="1" class="form-control" name="shift" value="{{ old('shift', $ciwSimply->shift) }}" required placeholder="Shift">
                                    </div>
                                    <div class="col-sm">
                                        <input type="number" class="form-control" name="line" value="{{ old('line', $ciwSimply->line) }}" required placeholder="Line">
                                    </div>
                                    <div class="col-sm">
                                        <input type="text" class="form-control" name="operator" value="{{ old('operator', $ciwSimply->operator) }}" required placeholder="Nama Operator">
                                    </div>
                                    <div class="col-sm">
                                        <input type="date" class="form-control" name="tanggal" value="{{ old('tanggal', $ciwSimply->tanggal) }}" required placeholder="Input tanggal">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-1">
                                        <input type="number" class="form-control waktu-input text-center" name="waktu1{{ $i }}" value="{{ $ciwSimply->{'waktu1'.$i} }}" required>
                                    </div>
                                </div>
                                @endfor
                        ...
                        <div class="card border-0 shadow rounded mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-1">
                                        <input type="number" class="form-control waktu-input text-center" name="waktu2{{ $i }}" value="{{ $ciwSimply->{'waktu2'.$i} }}" required>
                                    </div>
                                </div>
                                @endfor
                                <div class="col-sm total-waktu justify-content-end" id="total-waktu-card1" style="pointer-events: none; background-color: #f9f9f9; border: 1px solid #ced4da; font-size: larger;">
                        ...
                        <div class="card border-0 shadow rounded mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-1">
                                        <input type="number" class="form-control waktu-input text-center" name="waktu3{{ $i }}" value="{{ $ciwSimply->{'waktu3'.$i} }}" required>
                                    </div>
                                </div>
                                @endfor
                                <div class="col-sm total-waktu justify-content-end" id="total-waktu-card1" style="pointer-events: none; background-color: #f9f9f9; border: 1px solid #ced4da; font-size: larger;">
                        ...
                        <div class="card border-0 shadow rounded mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-1">
                                        <input type="number" class="form-control waktu-input text-center" name="waktu4{{ $i }}" value="{{ $ciwSimply->{'waktu4'.$i} }}" required>
                                    </div>
                                </div>
                                @endfor
                                <div class="col-sm total-waktu justify-content-end" id="total-waktu-card1" style="pointer-events: none; background-color: #f9f9f9; border: 1px solid #ced4da; font-size: larger;">
