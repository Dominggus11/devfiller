...
<head>
    ...
    <title>Approve Cip Simply</title>
    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="col-md-12">
                ...
                @endif
                <h3 class="text-center mb-4 text-white">Approve Cheklist Cip Simply</h3>
                <div>
                    <form action="{{ route('Admin.CipSimplies.update', $cipSimply->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                    {{-- Alat --}}
                    <div>
                        ...
                        <div class="card border-0 shadow rounded mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm">
                                        <input type="text" class="form-control" name="supervisor" value="{{ old('supervisor', $cipSimply->supervisor) }}" required placeholder="supervisor">
                                    </div>
                                    <div class="col-sm">
                                        <input type="number" max="3" min="1" class="form-control" name="shift" value="{{ old('shift', $cipSimply->shift) }}" readonly placeholder="Shift">
                                    </div>
                                    <div class="col-sm">
                                        <input type="number" class="form-control" name="line" value="{{ old('line', $cipSimply->line) }}" readonly placeholder="Line">
                                    </div>
                                    <div class="col-sm">
                                        <input type="text" class="form-control" name="operator" value="{{ old('operator', $cipSimply->operator) }}" readonly placeholder="Nama Operator">
                                    </div>
                                    <div class="col-sm">
                                        <input type="date" class="form-control" name="tanggal" value="{{ old('tanggal', $cipSimply->tanggal) }}" readonly placeholder="Input tanggal">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-1">
                                        <input type="number" class="form-control waktu-input text-center" name="waktu1{{ $i }}" value="{{ $cipSimply->{'waktu1'.$i} }}" readonly>
                                    </div>
                                </div>
                                @endfor
                        ...
                        <div class="card border-0 shadow rounded mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-1">
                                        <input type="number" class="form-control waktu-input text-center" name="waktu2{{ $i }}" value="{{ $cipSimply->{'waktu2'.$i} }}" readonly>
                                    </div>
                                </div>
                                @endfor
                                <div class="col-sm total-waktu justify-content-end" id="total-waktu-card1" style="pointer-events: none; background-color: #f9f9f9; border: 1px solid #ced4da; font-size: larger;">
                    ...
                    <div class="mb-4 d-flex justify-content-center">
                        ...
                        <a href="{{ route('Admin.CipSimplies.index') }}" class="btn btn-md btn-secondary ms-2">Back</a>
                    </div>  
                    </form>
                </div>
            </div>
